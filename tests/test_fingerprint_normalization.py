...
assert normalize_external_technology("HSTS") == ("hsts", "", "security-header")
assert normalize_external_technology("Cloudflare Bot Management") == ("cloudflare bot management", "", "security")
